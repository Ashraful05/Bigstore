    ...
    <div data-vide-bg="{{asset('/')}}/front/video/video">
            <div class="container">
                            ...
                            <div class=" con-w3l">
                                ...
                                <div class="col-md-3 m-wthree">
                                    <div class="col-m">
                                        ...
                                        <div class="mid-1">
                                            <div class="women">
                                                <h6><a href="single.html">{{$product->product_name}}</h6>
                                            </div>
                                            <div class="mid-2">
                                ...
                                <div class="col-md-3 m-wthree">
                                    <div class="col-m">
                                        ...
                                        <div class="mid-1">
                                            ...
                                            <div class="add">
                                                <button class="btn btn-danger my-cart-btn my-cart-b" data-id="7" data-name="Popcorn" data-summary="summary 7" data-price="1.00" data-quantity="1" data-image="{{asset('/')}}/front/images/of6.png">Add to Cart</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-3 pro-1">
                        <div class="col-m">
                            ...
                            <div class="mid-1">
                                ...
                                <div class="add add-2">
                                    <button class="btn btn-danger my-cart-btn my-cart-b" data-id="1" data-name="product 1" data-summary="summary 1" data-price="6.00" data-quantity="1" data-image="{{asset('/')}}/front/images/of16.png">Add to Cart</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 pro-1">
                        <div class="col-m">
                            ...
                            <div class="mid-1">
                                ...
                                <div class="add">
                                    <button class="btn btn-danger my-cart-btn my-cart-b" data-id="1" data-name="product 1" data-summary="summary 1" data-price="4.50" data-quantity="1" data-image="{{asset('/')}}/front/images/of17.png">Add to Cart</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 pro-1">
                        <div class="col-m">
                            ...
                            <div class="mid-1">
                                ...
                                <div class="add">
                                    <button class="btn btn-danger my-cart-btn my-cart-b" data-id="1" data-name="product 1" data-summary="summary 1" data-price="3.50" data-quantity="1" data-image="{{asset('/')}}/front/images/of18.png">Add to Cart</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 pro-1">
                        <div class="col-m">
                            ...
                            <div class="mid-1">
                                ...
                                <div class="add">
                                    <button class="btn btn-danger my-cart-btn my-cart-b" data-id="1" data-name="product 1" data-summary="summary 1" data-price="0.80" data-quantity="1" data-image="{{asset('/')}}/front/images/of19.png">Add to Cart</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 pro-1">
                        <div class="col-m">
                            ...
                            <div class="mid-1">
                                ...
                                <div class="add">
                                    <button class="btn btn-danger my-cart-btn my-cart-b" data-id="1" data-name="product 1" data-summary="summary 1" data-price="6.00" data-quantity="1" data-image="{{asset('/')}}/front/images/of20.png">Add to Cart</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 pro-1">
                        <div class="col-m">
                            ...
                            <div class="mid-1">
                                ...
                                <div class="add">
                                    <button class="btn btn-danger my-cart-btn my-cart-b" data-id="1" data-name="product 1" data-summary="summary 1" data-price="4.50" data-quantity="1" data-image="{{asset('/')}}/front/images/of21.png">Add to Cart</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 pro-1">
                        <div class="col-m">
                            ...
                            <div class="mid-1">
                                ...
                                <div class="add">
                                    <button class="btn btn-danger my-cart-btn my-cart-b" data-id="1" data-name="product 1" data-summary="summary 1" data-price="3.50" data-quantity="1" data-image="{{asset('/')}}/front/images/of22.png">Add to Cart</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 pro-1">
                        <div class="col-m">
                            ...
                            <div class="mid-1">
                                ...
                                <div class="add">
                                    <button class="btn btn-danger my-cart-btn my-cart-b" data-id="1" data-name="product 1" data-summary="summary 1" data-price="0.80" data-quantity="1" data-image="{{asset('/')}}/front/images/of23.png">Add to Cart</button>
                                </div>
                            </div>
                        </div>
                    </div>
