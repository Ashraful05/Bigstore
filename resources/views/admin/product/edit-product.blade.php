    ...
    <div class="row">
        <div class="col-md-11">
            <div class="panel panel-default">
                ...
                {{ Form::open(['route'=>'update-product','method'=>'POST','class'=>'form-horizontal',
                ...
                <!-- <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <label>
                                <input type="radio" name="publication_status" {{$product->publication_status==1 ? 'checked':''}}  value="1" />Published</label>
                            <label>
                                <input type="radio" name="publication_status" {{$product->publication_status==0 ? 'checked':''}} value="0" />Unpublished</label>
